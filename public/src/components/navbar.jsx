...
const Navbar = () => {
    ...
    const menuLinks = (
        <>
            {/* Links públicos */}
            <a href="/" className="text-white hover:text-purple-200 transition-colors duration-300 text-lg font-medium">Home</a>
            <a href="/about" className="text-white hover:text-purple-200 transition-colors duration-300 text-lg font-medium">Sobre</a>
            <a href="/service" className="text-white hover:text-purple-200 transition-colors duration-300 text-lg font-medium">Serviços</a>
            <a href="/contact" className="text-white hover:text-purple-200 transition-colors duration-300 text-lg font-medium">Contato</a>
    ...
    return (
        ...
        <nav className="w-full bg-gradient-to-r from-pink-300 to-pink-300 text-gray-800 py-0 px-2 shadow-lg fixed top-0 left-0 z-30">
