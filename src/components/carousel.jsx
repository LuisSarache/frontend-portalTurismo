...
import obelisco from "../assets/imagens/obelisco.png"
import torrefel from "../assets/imagens/torrefel.jpg"
import munique from "../assets/imagens/munique.jpg"
import templo from "../assets/imagens/templo.jpg"
import fuji from "../assets/imagens/fuji.jpg"
import moscow from "../assets/imagens/moscow.jpg"

// Array de objetos com dados dos pontos turísticos (imagem, título e descrição)
const tourist_places = [
    { Image: obelisco, title: "Obelisco de Buenos Aires", description: " Ponto turistico religioso" },
    { Image: torrefel, title: " Torre Eiffel", description: " Ponto turistico Atrativo" },
    { Image: munique, title: "Catedral de Munique", description: "Ponto turistico religioso" },
    { Image: templo, title: "Templo de Asakusa", description: "Ponto turistico religioso" },
    { Image: fuji, title: "Monte fuji", description: "O Maior monte do japão" },
    { Image: moscow, title: "Cadetral de Moscow", description: "Ponto turistico religioso" },
]
